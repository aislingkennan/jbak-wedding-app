        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#fdfaf5;border:1px solid #e8d9bf;border-radius:4px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:40px;">
              <p style="margin:0 0 20px 0;font-size:17px;font-family:'Cormorant Garamond',Georgia,serif;">Dear ${displayName},</p>
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Email Preview</h1>
        <p className="text-gray-500 text-sm mb-10">Exactly what guests will receive in their inbox.</p>

        <h2 className="text-lg font-semibold text-gray-700 mb-3">Ceremony + Dinner guests</h2>
        <div className="rounded shadow overflow-hidden mb-12">
          <iframe
            srcDoc={buildHtml(true, 'Megan & Stephen')}
            className="w-full border-0"
            style={{ height: '680px' }}
            title="Ceremony + Dinner email preview"
          />
        </div>

        <h2 className="text-lg font-semibold text-gray-700 mb-3">Dinner only guests</h2>
        <div className="rounded shadow overflow-hidden">
          <iframe
            srcDoc={buildHtml(false, 'Mitch & Andrea')}
            className="w-full border-0"
            style={{ height: '600px' }}
            title="Dinner only email preview"
          />
        </div>
      </div>
    </div>
